...
export const EditGallery: React.FC<EditGalleryProps> = ({ location, gallery }) => {
        ...
        <details className={styles.details}>
            ...
            <div className={styles.edit}>
                ...
                <form className={styles.form} onSubmit={(e) => e.preventDefault()} id='update_gallery_logos'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newLogo.title} onChange={handleNewLogo} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newLogo.url} onChange={handleNewLogo} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newLogo.class_name} onChange={handleNewLogo} />
                        <button className={styles.button} type="submit" onClick={handleAddNewLogo}><h3>Add Logo</h3></button>
                    </div>
                </form>
                ...
                <form onSubmit={(e) => e.preventDefault()} id='update_gallery_icons'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newIcon.title} onChange={handleNewIcon} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newIcon.url} onChange={handleNewIcon} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newIcon.class_name} onChange={handleNewIcon} />
                        <button className={styles.button} type="button" onClick={handleAddNewIcon}><h3>Add Icon</h3></button>
                    </div>
                </form>
                ...
                <form onSubmit={(e) => e.preventDefault()} id='update_gallery_animations'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newAnimation.title} onChange={handleNewAnimation} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newAnimation.url} onChange={handleNewAnimation} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newAnimation.class_name} onChange={handleNewAnimation} />
                        <button className={styles.button} type="button" onClick={handleAddNewAnimation}><h3>Add Animation</h3></button>
                    </div>
                </form>
                ...
                <form onSubmit={(e) => e.preventDefault()} id='update_gallery_uml_diagrams'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newUmlDiagram.title} onChange={handleNewUmlDiagram} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newUmlDiagram.url} onChange={handleNewUmlDiagram} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newUmlDiagram.class_name} onChange={handleNewUmlDiagram} />
                        <button className={styles.button} type="button" onClick={handleAddNewUmlDiagram}><h3>Add UML Diagram</h3></button>
                    </div>
                </form>
                ...
                <form onSubmit={(e) => e.preventDefault()} id='update_gallery_screenshot'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newScreenshot.title} onChange={handleNewScreenshot} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newScreenshot.url} onChange={handleNewScreenshot} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newScreenshot.class_name} onChange={handleNewScreenshot} />
                        <button className={styles.button} type="button" onClick={handleAddNewScreenshot}><h3>Add Screenshot</h3></button>
                    </div>
                </form>
                ...
                <form onSubmit={(e) => e.preventDefault()} id='update_gallery_previews'>
                    ...
                    <div className={styles['form-item']}>
                        <input className={styles.input}
                            type="text" name="title" placeholder="Title" value={newScreenshot.title} onChange={handleNewPreview} />
                        <input className={styles.input}
                            type="text" name="url" placeholder="URL" value={newScreenshot.url} onChange={handleNewPreview} />
                        <input className={styles.input}
                            type="text" name="class_name" placeholder="Class Name" value={newScreenshot.class_name} onChange={handleNewPreview} />
                        <button className={styles.button} type="button" onClick={handleAddNewPreview}><h3>Add Preview</h3></button>
                    </div>
                </form>
